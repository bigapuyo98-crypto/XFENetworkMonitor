...
extension NetworkPath {
    public static func == (lhs: NetworkPath, rhs: NetworkPath) -> Bool {
        lhs.status == rhs.status
            && lhs.connectionType == rhs.connectionType
            && lhs.isExpensive == rhs.isExpensive
            && lhs.isConstrained == rhs.isConstrained
            && lhs.supportsIPv4 == rhs.supportsIPv4
            && lhs.supportsIPv6 == rhs.supportsIPv6
            && lhs.supportsDNS == rhs.supportsDNS
    }
}
...
extension NetworkPath {
    ...
    public var isGoodForLargeTransfers: Bool {
    ...
    ///
    /// **判断条件**：网络质量为 good 及以上
    public var isGoodForHighQualityMedia: Bool {
